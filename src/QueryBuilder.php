<?php
    ...
    use Indiciez\Tuiz\Security;

    class QueryBuilder extends DBConfig{
        ...
        public static function builder(array $table,array $columns_list,array $conditions,int $limit): array {
            ...
            return (new QueryBuilder())->processQuery($sql_string);
        }

        public static function rawQuery(string $raw_query_string): array {
            return (new QueryBuilder())->processQuery($raw_query_string);
        }
    }